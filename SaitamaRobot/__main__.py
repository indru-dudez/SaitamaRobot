...
Build by [SI_NN_ER_LS](https://t.me/SI_NN_ER_LS). for group owners, I specialize in managing anime and similar themed groups.
You can find my list of available commands with /help.
"""

HELP_STRINGS = """
Hey there! My name is *{}*.
I'm a group manager bot and help admins manage their groups easily! Have a look at the following for an idea of some of \
the things I can help you with.

*Main* commands available:
 • /help: PM's you this message.
 • /help <module name>: PM's you info about that module.
 • /donate:You don't need to donate!
 • /settings:
...
SAITAMA_IMG = "https://telegra.ph/file/8eb5bffc40f12d5d2cd65.jpg"
            ...
            update.effective_message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                     ...
                     [
                         InlineKeyboardButton(
                             text="ManGaen Channel",
                             url=f"https://t.me/MANGAen"),
                         InlineKeyboardButton(
                             text="Movie Channel",
